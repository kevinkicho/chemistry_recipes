...
| **SEARCH-38** | Process-sequence stub empty vs error vs timeout: literature / patent / manufacturing harvest failures are not "No extractable public process sequence yet" / "Process route synthesis pending" / "retrieved yet"; leftover identity / annotation HTTP is not a process-sequence miss. Cached await-ai / await-facts stubs overlay harvest-failure copy on Monday pack / job-aid / RoutePanel / RouteCompare / manager brief. | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-39** | Ideal-page empty vs error vs timeout: literature / patent / manufacturing harvest failures are not "No process steps yet"; GHS harvest failures are not "No GHS text for this CID"; overview / manufacturing / property harvest failures are not "Missing process overview" / "Empty" / "Sparse". Stub-only await-ai / await-facts routes do not count as process-recipe fill. Leftover identity / annotation HTTP is not an ideal-page miss. Provenance chips still pass all traces (composite depth score). | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-40** | Transfer-readiness checklist empty vs error vs timeout: literature / patent / manufacturing harvest failures are not a clean Gap ("No process facts" / "0 lit · 0 patents" / stub-only steps); GHS harvest failures are not a clean EHS Gap. Stub-only await-ai / await-facts steps do not count as process-step fill. Leftover identity / annotation HTTP is not a checklist miss. Provenance chips still pass all traces (composite pack). | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-41** | Recipe-readiness empty vs error vs timeout: literature / patent / manufacturing harvest failures are not a clean gap ("Only 0 sourced condition atom(s)" / "No isolation language" / "Only 0 literature + 0 patent hit(s)"); leftover identity / annotation HTTP is not a recipe-readiness miss. Site-QMS stays a site gap. Provenance chips still pass all traces (composite). | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-42** | Campaign brief / agent empty vs error vs timeout: literature / patent / manufacturing harvest failures are not "Few condition observations" / "No reaction-network edges yet" / "Insufficient free-public evidence in the campaign package"; leftover identity / annotation HTTP is not a campaign miss. cachedCount === 0 stays a local-cache gap. | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-43** | Build-diagnostics Multi-source APIs / literature-patents empty vs error vs timeout: annotation harvest failures are not "none yet"; literature / patent harvest failures are not a muted 0 · 0 miss; leftover identity HTTP is not a diagnostics miss. Filled counts stay. | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-44** | Shift-pack empty vs error vs timeout: literature / patent / manufacturing harvest failures are not a clean N-step pack / "Lit/patents: 0/0" miss; stub-only await-ai / await-facts steps do not count as a public sequence. Leftover identity / annotation HTTP is not a shift-pack miss. "No saved shift packs for this CID yet" stays a local-cache gap. Provenance chips use process-fact traces (not leftover identity). | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-45** | MSAT compare board empty vs error vs timeout: literature / patent / manufacturing harvest failures are not "Similar public density" / a clean "0 / 0" literature-patents miss; leftover identity / annotation HTTP is not an MSAT-compare miss. Filled counts stay. Provenance chips stay composite (no leftover-identity live-fetch). | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-46** | PDF-pack clipboard manifest empty vs error vs timeout: literature / patent harvest failures are not a clean "Lit: 0 · Patents: 0" miss; leftover identity / annotation HTTP is not a PDF-pack miss. Filled counts stay. Provenance chips stay process-fact traces (no leftover-identity live-fetch). | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-47** | MSAT compare GHS statements empty vs error vs timeout: GHS harvest failures are not a clean "0" miss; leftover identity / annotation / literature HTTP is not an MSAT-compare GHS miss. Filled counts stay. Provenance chips stay composite (no leftover-identity live-fetch). | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-48** | PDF-pack clipboard process-facts empty vs error vs timeout: literature / patent / manufacturing harvest failures are not a clean "Process facts: 0" miss; leftover identity / annotation / GHS HTTP is not a PDF-pack process-facts miss. Filled counts stay. Provenance chips stay process-fact traces (no leftover-identity live-fetch). | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-49** | Site-handoff snapshot process-facts empty vs error vs timeout: literature / patent / manufacturing harvest failures are not a clean "Process facts: **0** sourced atoms" miss; leftover identity / annotation / GHS HTTP is not a site-handoff process-facts miss. Filled counts stay. Thin-to-useful chips stay composite (no leftover-identity live-fetch). | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-50** | Evidence critique process-facts metric empty vs error vs timeout: literature / patent / manufacturing harvest failures are not a clean "Process facts: 0 conditions · 0 unit ops" miss; leftover identity / annotation / GHS HTTP is not a critique process-facts miss. Filled counts stay. SEARCH-34 still only overlays procedure windows. Provenance chips still pass all traces (composite critique). | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-51** | Process-facts panel / operator job-aid header counts empty vs error vs timeout: literature / patent / manufacturing harvest failures are not a clean "0 conditions · 0 unit ops" miss; leftover identity / annotation / GHS HTTP is not a process-facts header miss. Filled counts stay. SEARCH-50 still only overlays the critique metric. Provenance chips stay process-fact traces (no leftover-identity live-fetch). | `test-search-contracts`, `test-product-path`, `test-provenance` |
| **SEARCH-52** | Densify-ready banner (DossierClientLoader loading chrome) empty vs error vs timeout: literature harvest failures are not a clean "Lit 0" miss; patent harvest failures are not a clean "Patents 0" miss; literature / patent / manufacturing harvest failures are not a clean "Facts 0 cond · 0 ops" miss; leftover identity / annotation / GHS HTTP is not a densify-ready banner miss. Filled counts stay. SEARCH-51 still only overlays the process-facts header. Loading chrome has no leftover-identity live-fetch. | `test-search-contracts`, `test-product-path`, `test-provenance` |
...
| **PROV-24** | Problem / unit-op search chips claim only literature / patent / manufacturing / GHS harvest HTTP (not leftover PubChem identity or annotation HTTP); they do not live-fetch identity | `test-provenance`, `test-search-contracts` |
| **PROV-25** | Procedure-vault chips claim only literature / patent / manufacturing / GHS harvest HTTP (not leftover PubChem identity or annotation HTTP); they do not live-fetch identity | `test-provenance`, `test-search-contracts`, `test-product-path` |
...
| **PROV-37** | Manufacturing-summary aside chips stay composite all-traces hydration (PROV-08 multi-API) but do not live-fetch leftover PubChem identity HTTP when traces are empty (identity `/property/` is not Manufacturing summary) | `test-provenance`, `test-search-contracts`, `test-product-path` |
