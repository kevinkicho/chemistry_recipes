...
export const CHEMISTRY_API_SOURCES: ApiSource[] = [
  ...
  },
  {
    ...
    priority: "P1",
    role: "Structured organic reaction records (browse + bulk datasets; live dossier deep-link)",
    endpointUrl: "https://open-reaction-database.org/",
    docsUrl: "https://docs.open-reaction-database.org/",
    category: "reactions",
    notes:
      "Browse UI linked from live dossiers. Prefer bulk download for ML/offline ingest; not plant SOPs.",
  },
  {
    id: "pubchem-patents",
