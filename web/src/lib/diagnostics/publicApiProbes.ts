...
export const PUBLIC_API_PROBE_DEFS: PublicProbeDef[] = [
  ...
  },
  {
    ...
    gatherFamilies: ["patent-epmc-densify"],
    bodyMustMatch: "resultList|hitCount",
  },
  {
    id: "patent-literature",
    name: "Patent-adjacent literature",
    organization: "EMBL-EBI",
    category: "patents",
    url: `https://www.ebi.ac.uk/europepmc/webservices/rest/search?query=${encodeURIComponent(`(TITLE_ABS:"${Q}") AND (patent OR USPTO OR "process for preparing")`)}&resultType=core&pageSize=1&format=json`,
    gatherFamilies: ["patent-literature"],
    bodyMustMatch: "resultList|hitCount",
  },
  {
    id: "pubmed",
