 ...
 * Plant environment / apparatus and process recipe / route / control-points
 * chips reuse this family — they derive from process facts, not leftover
 * PubChem identity HTTP.
 */
