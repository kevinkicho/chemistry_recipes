...
const LIVE_SECTIONS: Omit<TocLink, "href">[] = [
  ...
  { id: "evidence-explainer", label: "Evidence score" },
  { id: "source-coverage", label: "Source coverage" },
  { id: "manager-brief", label: "Manager brief" },
  { id: "operator-job-aid", label: "Operator job aid" },
  { id: "process-facts", label: "Process facts" },
  { id: "local-text-enrich", label: "Local enrich" },
  { id: "validation-checklist", label: "Transfer checklist" },
  { id: "routes", label: "Process recipe" },
  { id: "critical-board", label: "Control points" },
  { id: "multi-source", label: "Multi-source APIs" },
  { id: "related-entities", label: "Related materials" },
  { id: "route-compare", label: "Compare recipes" },
